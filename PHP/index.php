<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="dashborad_style.php">
    ...
    <body>
        <section id="header">
         ...
         <div class="box1">
            <h3 class="box-title">Total task</h3>
            <hr class="line">
            <h1 style='color:blue; margin: 67px'>15</h1>
        </div>
        <div class="box2">
            <h3 class="box-title">Completed</h3>
            <hr class="line">
            <h1 style='color:green; margin: 67px'>08</h1>
        </div>
        <div class="box3">
            <h3 class="box-title">Pending</h3>
            <hr class="line"> 
            <h1 style='color:red;margin: 67px'>03</h1>
        </div>
        <div class="box4">
            <h3 class="box-title">In-Progress</h3>
            <hr class="line">
            <h1 style='margin: 67px'>04</h1>
        </div>
