<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="editemployee_style.php"> 
    ...
    ?>
        ...
        <div class="add-task">
            ...
            <form method="POST" action="dbedit.php?id=<?php echo $id = $_GET['id'];?>">

        <div>
        <input type="text" placeholder="First Name" class="fname" name="fname" value="<?php echo $row['Firstname']; ?>" required >
        </div>
        <div>
            <input type="text" placeholder="Last Name" class="lname" name="lname" value="<?php echo $row['Lastname']; ?>" >
        </div>
