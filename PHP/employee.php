<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="employee_style.php"> 
    ...
    <body>
        ...
        <div class="add-task">
            <form  method="post" action="dbemployee_store.php">
        ...
        <div>
        <input type="password" placeholder="Enter Password" class="Enter-Password" name="password" >
    </div>
